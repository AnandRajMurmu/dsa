...
def right_rotate_array_by_k_naive(array, rotate):
    """
    Approach:
        ...
        - Shift the last k elements left by N-k positions.
...
def right_rotate_array_by_k_optimal(array, rotate):
    """
    Approach:
        - Return immediately if the array is empty.
        - Normalize the rotation count: k = rotate % N.
    ...
    reverse_array_in_place(array, n - k, n - 1)
    reverse_array_in_place(array, 0, n - k - 1)
